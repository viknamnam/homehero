...
export const copy = {
  onboarding: {
    ...
    chooseCreate: 'Start a new household',
    chooseCreateSub: 'Set up your home and start logging together.',
    chooseJoin: 'Join my family',
    chooseJoinSub: 'Got an invite code or QR? Join an existing home.',
    chooseSignInNote: 'Joining or backing up uses a quick email sign-in — no password to remember.',
    back: 'Back',
    createSignInHint: 'You can start right away. Sign in later from Settings to back up and invite your family.',
  ...
  paywall: {
    title: 'Keep your home team going',
    sub: 'Your free trial has finished. Subscribe to keep logging, planning, and sending thanks together.',
    points: [
      'Everything stays in one place for the whole family',
      'Unlimited logging, plans, and appreciation',
      'Kids Mode, avatars, and weekly summaries',
    ],
    householdNote: 'One subscription covers your whole household.',
    subscribe: 'Subscribe',
    subscribeWithPrice: (price: string) => `Subscribe — ${price}`,
    subscribing: 'Setting up…',
    restore: 'Restore a purchase',
    exportTitle: 'Your data is always yours',
    exportSub: "Not ready to subscribe? You can export everything any time — we never lock your data away.",
  ...
  kids: {
    ...
    badgeNext: 'Next up!',
    badgeEarnedTag: 'Earned! ✓',
    allDoneExtra: 'Did something extra? Tap "I helped!" below to add it.',
    ...
    todayProgressTitle: "Today's missions",
    todayProgressSub: (done: number, total: number) => `${done} of ${total} done — keep going!`,
    todayProgressDone: 'All done for today! You\'re a star ⭐',
  ...
  settings: {
    ...
    kidDeviceCta: 'Set up their own device',
    kidDeviceTitle: (name: string) => `${name}'s device`,
    kidDeviceSub: "On their device, open HeroNest and scan this. It links just to their world — no grown-up access. The code works once, for 24 hours.",
  ...
  sync: {
    ...
    signOutNote: "We'll save your changes first. Your home stays safe in your account — sign back in any time to pick up where you left off.",
